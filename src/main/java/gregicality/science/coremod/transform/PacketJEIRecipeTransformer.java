package gregicality.science.coremod.transform;

import gregicality.science.coremod.GAClassTransformer.ClassMapper;
import gregicality.science.coremod.GAClassTransformer.GAMethodVisitor;
        ...
        public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
            if (opcode == Opcodes.INVOKESTATIC && owner.equals("appeng/util/Platform") && name.equals("poweredExtraction")) {
                super.visitMethodInsn(Opcodes.INVOKESTATIC,
                        "gregicality/science/coremod/hooks/AppliedEnergistics2Hooks",
                        "poweredExtraction",
