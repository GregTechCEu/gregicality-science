...
public class PlasmaCondenserInfo extends MultiblockInfoPage {
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        ...
        builder.aisle( "#####", "#XXX#", "#XXX#", "#XXX#", "#####")
                ...
                .where('H', maintenanceIfEnabled(GCYSciMetaBlocks.METAL_CASING_1.getState(MetalCasing1.CasingType.HASTELLOY_N)), EnumFacing.WEST)
                .where('X', GCYSciMetaBlocks.METAL_CASING_1.getState(MetalCasing1.CasingType.HASTELLOY_N))
                .where('G', MetaBlocks.TURBINE_CASING.getState(BlockTurbineCasing.TurbineCasingType.STEEL_GEARBOX))
                .where('P', MetaBlocks.BOILER_CASING.getState(BlockBoilerCasing.BoilerCasingType.TUNGSTENSTEEL_PIPE))
                .where('#', Blocks.AIR.getDefaultState())
                .where('p', GCYSciMetaBlocks.PUMP_CASING.getState(PumpCasing.CasingType.PUMP_LUV))
    ...
    protected void generateBlockTooltips() {
        ...
        this.addBlockTooltip(GCYSciMetaBlocks.METAL_CASING_1.getItemVariant(MetalCasing1.CasingType.HASTELLOY_N), casingTooltip);
    }
