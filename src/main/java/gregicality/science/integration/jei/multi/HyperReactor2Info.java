...
public class HyperReactor2Info extends MultiblockInfoPage {
    ...
    public MultiblockControllerBase getController() {
        return GCYSciTileEntities.HYPER_REACTOR[1];
    }
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        GAMultiblockShapeInfo.Builder builder = GAMultiblockShapeInfo.builder();
         builder.aisle("#######C#######", "#####CCCCC#####", "#######C#######")
                ...
                .aisle("####CCCCCCC####", "###CC#####CC###", "####CCCCCCC####")
                .aisle("#######C#######", "#####CCCCC#####", "#######C#######")
                .where('S', GCYSciTileEntities.HYPER_REACTOR[1], EnumFacing.WEST)
                .where('M', maintenanceIfEnabled(GCYSciMetaBlocks.REACTOR_CASING.getState(GAReactorCasing.CasingType.HYPER_CASING)), EnumFacing.WEST)
                .where('C', GCYSciMetaBlocks.REACTOR_CASING.getState(GAReactorCasing.CasingType.HYPER_CASING))
                ...
                .where('H', GCYSciMetaBlocks.REACTOR_CASING.getState(GAReactorCasing.CasingType.HYPER_CORE_2))
