    ...
    protected void updateFormedValid() {
        if (!getWorld().isRemote) {
            ...
            if (getOffsetTimer() % 20 == 0) {
                FluidStack pyrotheumFluid = GCYSciMaterials.Pyrotheum.getFluid((int) currentDrillingFluid);
                FluidStack cryotheumFluid = GCYSciMaterials.Cryotheum.getFluid((int) currentDrillingFluid);
