...
public class UltimateMaterials { //todo
...
//                .fluidInputs(GCYSMaterials.NobleGasesMixture.getFluid(6000))
...
//                .inputs(GCYSMetaBlocks.FUSION_CASING.getItemVariant(GAFusionCasing.CasingType.ADV_FUSION_COIL_4))
...
//                .inputs(GCYSMetaBlocks.EXPLOSIVE.getItemVariant(GAExplosive.ExplosiveType.QCD_CHARGE))
...
//                .inputs(GCYSMetaBlocks.EXPLOSIVE.getItemVariant(GAExplosive.ExplosiveType.QCD_CHARGE,2))
