...
import static gregicality.science.api.GCYSciMaterials.LiquidHelium;
import static gregicality.science.api.GCYSciMaterials.OrganicFertilizer;
import static gregicality.science.api.material.GAMaterialFlags.DISABLE_AUTOGENERATED_MIXER_RECIPE;
...
public class RecipeHandler {
    ...
    private static final ItemStack[] EXPLOSIVES = new ItemStack[]{
            GCYSciMetaBlocks.EXPLOSIVE.getItemVariant(GAExplosive.ExplosiveType.POWDER_BARREL, 48),
            new ItemStack(Blocks.TNT, 24),
            MetaItems.DYNAMITE.getStackForm(12),
            GCYSciMetaBlocks.EXPLOSIVE.getItemVariant(GAExplosive.ExplosiveType.ITNT, 6)};
    ...
    private static void registerStellarForgeRecipes(OrePrefix prefix, Material material, BlastProperty property) {
        if (property.getBlastTemperature() >= 14500) {
            ...
            if (property.getBlastTemperature() >= 65000)
                explosive = GCYSciMetaBlocks.EXPLOSIVE.getItemVariant(GAExplosive.ExplosiveType.QCD_CHARGE);
            else if (property.getBlastTemperature() >= 35000)
                explosive = GCYSciMetaBlocks.EXPLOSIVE.getItemVariant(GAExplosive.ExplosiveType.LEPTONIC_CHARGE);
            else if (property.getBlastTemperature() >= 22500)
                explosive =  GCYSciMetaBlocks.EXPLOSIVE.getItemVariant(GAExplosive.ExplosiveType.TARANIUM_CHARGE);
            else
                explosive = GCYSciMetaBlocks.EXPLOSIVE.getItemVariant(GAExplosive.ExplosiveType.NAQUADRIA_CHARGE);
