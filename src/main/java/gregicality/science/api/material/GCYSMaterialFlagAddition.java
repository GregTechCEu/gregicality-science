...
//        Uranium.addFlag(GENERATE_LONG_ROD);
        ...
        Germanium.addFlags(GA_CORE_METAL.toArray(new MaterialFlag[0]));
        Iodine.addFlags(GA_CORE_METAL.toArray(new MaterialFlag[0]));
        Ytterbium.addFlags(GA_CORE_METAL.toArray(new MaterialFlag[0]));
        Thulium.addFlags(GA_CORE_METAL.toArray(new MaterialFlag[0]));
        Erbium.addFlags(GA_CORE_METAL.toArray(new MaterialFlag[0]));
        Holmium.addFlags(GA_CORE_METAL.toArray(new MaterialFlag[0]));
        Dysprosium.addFlags(GA_CORE_METAL.toArray(new MaterialFlag[0]));
        Terbium.addFlags(GA_CORE_METAL.toArray(new MaterialFlag[0]));
        Gadolinium.addFlags(GA_CORE_METAL.toArray(new MaterialFlag[0]));
        Scandium.addFlags(GA_CORE_METAL.toArray(new MaterialFlag[0]));
        Cerium.addFlags(GA_CORE_METAL.toArray(new MaterialFlag[0]));
        Praseodymium.addFlags(GA_CORE_METAL.toArray(new MaterialFlag[0]));
    ...
    private static void initOres() {
        ...
        property.setOreByProducts(Saltpeter, Saltpeter, Lepidolite);
