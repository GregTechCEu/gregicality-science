...
public class GAFirstDegreeMaterials {
    ...
    public static void register() {
        ...
        LithiumTitanate = new Material.Builder(3581, "lithium_titanate")
                ...
                .flags(GA_CORE_METAL, GENERATE_PLATE, DISABLE_DECOMPOSITION)
        ...
        NaquadahSulfate = new Material.Builder(3607, "naquadah_sulfate")
                .fluid()
                .colorAverage()
        ...
        Legendarium = new Material.Builder(3950, "legendarium")
                .dust()
                .flags(DISABLE_DECOMPOSITION)
                .components(Naquadah, 1, NaquadahEnriched, 1, Naquadria, 1, Duranium, 1, Tritanium, 1, Trinium, 1)
                .build();
