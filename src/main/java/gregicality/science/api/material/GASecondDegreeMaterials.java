...
public class GASecondDegreeMaterials {
    ...
    public static void register() {
        ...
        StrontiumSuperconductor = new Material.Builder(11695, "strontium_superconductor")
                ...
                .flags(DISABLE_DECOMPOSITION)
                .components(Ruthenium, 1, Seaborgium, 1, GCYSMaterials.Celestine, 4)
                .build();
        ...
        Quantum = new Material.Builder(11699, "quantum")
                ...
                .flags(GA_CORE_METAL, DISABLE_DECOMPOSITION)
                .components(Stellite, 15, Gallium, 5, Americium241, 5, Palladium, 5, Bismuth, 5, Germanium, 5, SiliconCarbide, 5)
                .blastTemp(11400)
                .build();
