package gregicality.science.api.machine;
    ...
    public void update() {
        ...
        if (getQubitStored() >= getOutputQubit() && getOutputQubit() > 0 && getOutputParallel() > 0) {
            ...
            for (EnumFacing side : EnumFacing.VALUES) {
                ...
                if (tileEntity != null && tileEntity.hasCapability(GCYSciCapabilities.QBIT_CAPABILITY, oppositeSide)) {
                    IQubitContainer qubitContainer = tileEntity.getCapability(GCYSciCapabilities.QBIT_CAPABILITY, oppositeSide);
