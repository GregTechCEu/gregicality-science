package gregicality.science.recipes.categories;

import gregicality.science.item.*;
import gregicality.science.item.components.*;
...
import static gregicality.science.item.CellCasing.CellType.*;
import static gregicality.science.item.GAHeatingCoil.CoilType.*;
import static gregicality.science.item.GAMetaItems.*;
import static gregicality.science.item.GAMultiblockCasing.CasingType.*;
import static gregicality.science.item.GAMultiblockCasing2.CasingType.*;
import static gregicality.science.item.GAQuantumCasing.CasingType.COMPUTER;
import static gregicality.science.item.GAReactorCasing.CasingType.*;
...
import static gregicality.science.item.GATransparentCasing.CasingType.*;
