package gregicality.science.recipes.categories.circuits.components;

import static gregicality.science.GAMaterials.*;
import static gregicality.science.item.GAExplosive.ExplosiveType.LEPTONIC_CHARGE;
import static gregicality.science.item.GAExplosive.ExplosiveType.QCD_CHARGE;
import static gregicality.science.item.GAMetaBlocks.EXPLOSIVE;
import static gregicality.science.item.GAMetaBlocks.FUSION_CASING;
import static gregicality.science.item.GAMetaItems.*;
import static gregicality.science.item.fusion.GAFusionCasing.CasingType.ADV_FUSION_COIL_1;
import static gregicality.science.recipes.GARecipeMaps.*;
